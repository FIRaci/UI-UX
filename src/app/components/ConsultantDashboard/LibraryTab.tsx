  ...
  return (
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
      {ARTICLES.map((a, i) => (
        <Card
          key={i}
          className="overflow-hidden bg-white border border-slate-100 hover:border-emerald-100 hover:shadow-md transition-all duration-300 cursor-pointer group card-hover"
