                        ...
                        <div className="flex flex-wrap gap-2">
                          {msg.suggestedActions.map((sa, i) => (
                            <button
                              ...
                              className="px-3.5 py-2 bg-gradient-to-br from-emerald-500 to-teal-600 text-white rounded-xl text-xs font-semibold hover:from-emerald-600 hover:to-teal-700 transition-all active:scale-95 shadow-md shadow-emerald-500/20 flex items-center gap-1.5"
                            >
